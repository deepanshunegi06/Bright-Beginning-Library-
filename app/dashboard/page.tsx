            ...
            {!userData.subscriptionExpiryDate ? (
              <div className="bg-orange-50 border border-orange-300 rounded-lg p-4 mb-4">
                <div className="flex items-start">
                  <svg
                    className="w-6 h-6 text-orange-600 mr-3 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-orange-700">
                      You haven't made your first payment yet. Please contact admin to make payment and activate your subscription.
                    </p>
                  </div>
                </div>
              </div>
